...
export const featuredData = {
	...
	featured: [
		...
		},
		{
			...
			content:
				"As a freelance designer/developer, I offered creative designs and technical solutions that improved the overall code quality, page responsiveness, SEO, and design consistency across the site.",
		...
		},
		{
			...
			content:
				"A custom built website for Expo Home Improvement, a home improvement company located in Texas",
			role: "Lead Developer",
			devs: "Eric King",
